...
public class PortManagementExpandableAdapterNew
        extends AbstractExpandableItemAdapter<PortManagementExpandableAdapterNew.MyGroupViewHolder, PortManagementExpandableAdapterNew.MyChildViewHolder> {
...
//            }
    ...
    public PortManagementExpandableAdapterNew(ExampleExpandableDataProvider dataProvider) {
    ...
    public void onBindChildViewHolder(MyChildViewHolder holder, int groupPosition, int childPosition, int viewType) {
        // group item
        final Controller item = mProvider.getChildItem(groupPosition, childPosition);

        // set text
        holder.name.setText(item.getControllerId());
    }
